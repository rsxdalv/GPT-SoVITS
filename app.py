...
# 设置国际化支持
i18n = i18n_module.I18nAuto(language=app_config.locale, locale_path=f"gpt_sovits/Synthesizers/{synthesizer_name}/configs/i18n/locale")
...
def main():
    ...
    if app_config.also_enable_api == True:
        ...
        from gpt_sovits.src.api_utils import get_gradio_frp, get_localhost_ipv4_address
